...
Консольний додаток для обліку успішності студентів, розроблений на **Kotlin**. Проект реалізовано з суворим дотриманням **принципів ООП** та **багатошарової архітектури**.
